...
Connects to Discord via the Gateway WebSocket, stays online, and processes help requests as they arrive. The bot keeps SHA, online age, and update age fixed in status, then rotates the final banner between answered-question counters and monitored channel count.
